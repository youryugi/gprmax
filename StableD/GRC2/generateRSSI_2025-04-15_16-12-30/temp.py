import numpy as np
data1 = np.load(r"C:\Users\79152\Desktop\3rdtopic\StableD\GRC2\generateRSSI_2025-04-15_16-12-30\weights_16_experiments\excluded_1_1_1_1\untrained\context_1_1_1_1\samples.npy")  # 形状 (1, 28, 28, 4)
print(data1.shape)
